...
const REQUIRED_COLUMNS = ['namePrefix', 'name', 'dob', 'guardianName', 'email', 'phone'];
...
export const BATCH_COLUMNS = [
    'batchName', 'size', 'batchStartDate', 'batchEndDate', 'courseId',
...
function validateBatchRow(row, rowNumber) {
    ...
    const numeric = ['size', 'trainingHoursPerDay', 'totalFees', 'skillingCategoryId'];
