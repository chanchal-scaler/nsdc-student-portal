 ...
 */
export async function uploadStudents({ userName, password, students, onProgress }) {
    ...
    for (const student of students) {
        ...
        while (!done) {
            try {
                ...
                results.push({ ...student, candidateId: '', status: 'FAILED', error: err.message });
                failed++;
                done = true;
            }
        }
