...
async function previewPayload() {
  ...
  let summary = body.total + ' result(s) across ' + body.groups + ' batch request(s). Nothing was sent to NSDC.';
  if (body.skipped) summary += ' ' + body.skipped + ' already submitted, skipped.';
